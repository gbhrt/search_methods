...
{ 
	...
	string folder = "files1/a star/complex/";//no path easy input
	...
	string input_file_name = folder+"input.txt";//_orginal input_hard_A_star input_hard_BFS
	string output_file_name = folder+"output_.txt";
